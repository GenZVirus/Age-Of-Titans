package com.GenZVirus.AgeOfTitans.Container;

import java.util.Objects;

import com.GenZVirus.AgeOfTitans.Init.BlockInit;
import com.GenZVirus.AgeOfTitans.Init.ModContainerTypes;
import com.GenZVirus.AgeOfTitans.TileEntity.ExampleChestTileEntity;
...
public class ExampleChestContainer extends Container {
	...
	public ExampleChestContainer(final int windowId, final PlayerInventory playerInventory,
		...
		int startPlayerInvY = startY * 5 + 14;
		...
		// Hotbar
		int hotbarY = startPlayerInvY + (startPlayerInvY / 2) + 6;
		for (int column = 0; column < 9; ++column) {
