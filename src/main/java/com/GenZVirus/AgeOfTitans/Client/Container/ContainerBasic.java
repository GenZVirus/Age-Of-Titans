   ...
   */
    ...
    final int SLOT_Y_SPACING = 18;
		...
		for (int x = 0; x < TE_INVENTORY_SLOT_COUNT; x++) {
			int slotNumber = x;
			addSlot(new Slot(chestContents, slotNumber, TILE_INVENTORY_XPOS + SLOT_X_SPACING * tile_inventory_xpos_offset, TILE_INVENTORY_YPOS + TILE_INVENTORY_YPOS_OFFSET));
			if((x + 1) % 9 == 0 && x != 0) {
