...
public class TitaniumDaggerSetBonus {
	...
	public static void SetBonus(LivingDamageEvent event) {
		...
		if(attacker.getHeldItemMainhand().getItem().equals(ItemInit.TITANIUM_DAGGER.get())) {
			if(attacker.getHeldItemOffhand().getItem().equals(ItemInit.TITANIUM_DAGGER.get())) {
