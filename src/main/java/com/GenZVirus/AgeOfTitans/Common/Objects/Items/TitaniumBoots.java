...
public class TitaniumBoots extends ArmorItem{
	...
	public TitaniumBoots(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		return (A) new TitaniumBootsModel();
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
		return "ageoftitans:textures/models/armor/titanium_boots.png";
	}
