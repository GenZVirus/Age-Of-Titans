...
public class GravityZoneParticle extends SpriteTexturedParticle{
	...
	public GravityZoneParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn,
			double xSpeedIn, double ySpeedIn, double zSpeedIn, GravityZoneParticleData data, IAnimatedSprite sprite) {
	...
	public static class Factory implements IParticleFactory<GravityZoneParticleData>{
		...
		@Override
		public Particle makeParticle(GravityZoneParticleData typeIn, World worldIn, double x, double y, double z,
