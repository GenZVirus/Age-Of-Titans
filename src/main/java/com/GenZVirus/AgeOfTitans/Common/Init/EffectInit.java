...
public class EffectInit {
	...
	public static final RegistryObject<Effect> TIME_STOP = MOD_EFFECTS.register("time_stop", () -> new ModEffect(ModEffect.AOTType.SPELL, EffectType.HARMFUL, 0).addAttributesModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF0", -1.0D, AttributeModifier.Operation.MULTIPLY_TOTAL)
