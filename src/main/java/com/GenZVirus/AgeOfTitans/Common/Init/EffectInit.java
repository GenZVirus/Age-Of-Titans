...
public class EffectInit {
	...
	public static final RegistryObject<Effect> GRAVITY_FIELD = MOD_EFFECTS.register("gravity_field", () -> new ModEffect(ModEffect.AOTType.SPELL, EffectType.HARMFUL, 0).addAttributesModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF0", -1.0D, AttributeModifier.Operation.MULTIPLY_TOTAL)
																																								.addAttributesModifier(SharedMonsterAttributes.ATTACK_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF1", -1.0D, AttributeModifier.Operation.MULTIPLY_TOTAL)
																																								.addAttributesModifier(SharedMonsterAttributes.FLYING_SPEED, "AF8B6E3F-3328-4C0A-AA36-CCC2BB9DBEF0", -1.0D, AttributeModifier.Operation.MULTIPLY_TOTAL)
																																								.addAttributesModifier(SharedMonsterAttributes.KNOCKBACK_RESISTANCE, "AF8B6E3F-3328-4C0A-AA36-5BA2CBADBEFA", 1000.0D, AttributeModifier.Operation.ADDITION));
